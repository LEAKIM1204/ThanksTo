...
import org.techtown.thanksto.R;
...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu01Button.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
        		Intent intent = new Intent(getApplicationContext(), org.techtown.thanksto.CustomerActivity.class);
        ...
        menu02Button.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
        		Intent intent = new Intent(getApplicationContext(), org.techtown.thanksto.RevenueActivity.class);
        ...
        menu03Button.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
        		Intent intent = new Intent(getApplicationContext(), org.techtown.thanksto.ProductActivity.class);
